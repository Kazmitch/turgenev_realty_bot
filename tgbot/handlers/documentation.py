...
from tgbot.keyboards.documentation_keyboard import documents_keyboard, documentation_cd
...
async def share_document(call: CallbackQuery, callback_data: dict, **kwargs):
    ...
    # document_bytes = io.BytesIO(new_document)
    file = InputFile(path_or_bytesio='media/arbat_stars/documents/проектная_декларайия_1.pdf')
