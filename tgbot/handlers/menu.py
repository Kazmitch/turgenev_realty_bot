...
async def menu(call: Union[CallbackQuery, Message], state: FSMContext, influx_client, callback_data: dict = None, **kwargs):
    if isinstance(call, Message):
        ...
        await log_stat(influx_client, message.from_user, message.date, event='Отказ отправки контакта')
        ...
        await log_stat(influx_client, call.from_user, call.message.date, event='Возврат в главное меню')
